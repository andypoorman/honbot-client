var heroData = {
  ...
  "Hero_Fairy": {
    "10": {
      "hero_id": "10",
      "disp_name": "Nymphora",
      "description": "Nymphora has long been a protectress of Newerth&#039;s secret beauties, its secluded glades and crystal springs.  One might think that the paragon of butterflies and skylarks would have little role in the brutal carnage that has engulfed the world, but one need only see the tiny fangs Revealed by her smile to know that she holds secret dangers of her own.",
      "primaryattribute": "Intelligence",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Soulstealer": {
    "24": {
      ...
      "description": "The priests tell young men bound for the battlefield that if they fall, Elysian fields and peace awaits them.  But this is not strictly true, not as long as the Soulstealer walks the battlefield.  Gathering the spirits of those he kills in a bloody, shadowy sack, he augments his own power with their suffering.  Those who see him quake in terror to know that death, for them, will be no release, but only a fiery captivity and oblivion.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Hellbourne"
    }
  ...
  "Hero_WolfMan": {
    "29": {
      "hero_id": "29",
      "disp_name": "War Beast",
      "description": "Once a hound keeper in the underworld, War Beast heeded the call to arms in order to feed the victims of Newerth to his pets. War Beast&#039;s allegiance was never questioned. His hunger for carnage remains unending, feeding the animal within.",
      "primaryattribute": "Strength",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_Yogi": {
    "30": {
      "hero_id": "30",
      "disp_name": "Wildsoul",
      "description": "Is the mighty Wildsoul a Beast who dreamed himself a Man, or a Man who dreamed himself a Beast?  As much a bear as a human, this druidic warrior draws upon primordial woodland energies to strengthen himself and crush those who threaten the natural life of Newerth.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Scout": {
    "44": {
      "hero_id": "44",
      "disp_name": "Scout",
      "description": "Trained since youth to be swift, silent, and deadly, Scouts spend much of their lives deep in the wild, apart from their brethren.  After the alliance with the Beast Horde, they learned yet more ways of the wild, and turned all their craft to defeating the Hellbourne.  Though many view them as aloof, none doubt the importance of Scouts in the war against the daemons, as the countless enemy corpses, dead by a single blow, attest.",
      "primaryattribute": "Agility",
      "attacktype": "melee",
      "team": "Legion"
    }
  ...
  "Hero_BabaYaga": {
    "104": {
      ...
      "description": "The Wretched Hag haunted Newerth&#039;s darkness long before the Hellbourne spilled forth.  A fiendish hag fatted off the flesh of children and virgin brides, she keeps as her only company a swarm of bats -- the only creatures that can abide her shrieking cries.",
      "primaryattribute": "Intelligence",
      "attacktype": "ranged",
      "team": "Hellbourne"
    }
  ...
  "Hero_CorruptedDisciple": {
    "114": {
      ...
      "description": "Having traded Sol&#039;s sacred flame for the potent and unholy energy of the Hellbourne, the Corrupted Disciple is now little more than a battery of black magic.  He unleashes this fell sorcery in many forms, some to his benefit but all to the agony of those around him.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Hellbourne"
    }
  ...
  "Hero_Bephelgor": {
    "127": {
      ...
      "description": "Balphagore&#039;s gluttonous love of corpses draws him to wherever the Hellbourne&#039;s atrocities are at their worst.  Armed with an array of dark powers, this daemon is not to be trifled with when hungry -- and Balphagore is always hungry.",
      "primaryattribute": "Strength",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_Tundra": {
    "160": {
      "hero_id": "160",
      "disp_name": "Tundra",
      "description": "From the ice-caverns of the Frostfield hails Tundra, a white ape shaman of enormous size and power. His thundering voice commands the obedience of wild creatures and his magical powers conjure up the terrible cold of his northern home. Even fiery Hellbourne daemons feel a chill as he enters the fray.",
      "primaryattribute": "Strength",
      "attacktype": "melee",
      "team": "Legion"
    }
  ...
  "Hero_Tremble": {
    "170": {
      "hero_id": "170",
      "disp_name": "Tremble",
      "description": "Hellbourne corruption has spread across Newerth--and deep into it as well. From beneath the crusted depths emerges the carapaced undying horror that is Tremble, awakened to wreak havoc upon the Legion forces. Mysterious terrain deformations seem to herald his arrival, while a trail of corpses marks his path of departure.",
      "primaryattribute": "Agility",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_Ra": {
    "192": {
      "hero_id": "192",
      "disp_name": " \t\tAmun-Ra",
      "description": "The corrupted disciples of Sol harnessed the errant energies of the sun, and from that culmination of twisted nether emerged the ancient daemon god Amun-Ra, abomination of all that is light and holy. Fused together by black fire and fury, this immortal construct threatens to raze the lands with every burning step, defiling everything he touches with heretical fervor.",
      "primaryattribute": "Strength",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_Parasite": {
    "194": {
      "hero_id": "194",
      "disp_name": "Parasite",
      "description": "While the world above burned, within the deepest crevices of Newerth an abominable conglomeration of sentient gels, pathogens, and other lurkers of the deep simmered in a primordial pool, slowly evolving and multiplying. From this cesspool emerged the Parasite, sickeningly intelligent and chaotically evil.",
      "primaryattribute": "Intelligence",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_EmeraldWarden": {
    "195": {
      ...
      "description": "From a lost scout&#039;s journal: This visage of a great horned beast, imposing in stature and ornately bejeweled, descends to us a representative of an unknown druidic sect of beasts. At his behest lesser creatures of the forest fall under command, and when his bow is raised a foe shall fall.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_MasterOfArms": {
    "202": {
      ...
      "description": "Efficient and deadly, the Master of Arms dispatches his foes with blazing speed and pinpoint accuracy. With an arsenal rivaled by none he spreads chaos among his enemies while rallying his allies with his lust for battle.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Geomancer": {
    "204": {
      "hero_id": "204",
      "disp_name": "Geomancer",
      "description": "As the murder, atrocity, and sin intensified during Man&#039;s Fall from Light, the primordial Geomancers began to stir deep beneath the surface of the Hivelands. They tunneled toward the suffering with scores of daemons crowding behind, anxious to harvest and feed.",
      "primaryattribute": "Intelligence",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_Cthulhuphant": {
    "206": {
      ...
      "description": "Lost beneath the depths of the darkest sea, a dead behemoth dreamt a nightmare of unfathomable evil. Infused by the primal energies of the earth, his dream took to reality as a living omen to insanity, trodding out of the ocean floor and onto land.",
      "primaryattribute": "Strength",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_Monarch": {
    "207": {
      "hero_id": "207",
      "disp_name": "Monarch",
      "description": "Whereas the Moon Queen ruled over the night, the Monarch held dominion over day. And when her kin brought themselves into the fight against the Hellbourne, the Monarch herself pledged her hand to the cause.",
      "primaryattribute": "Intelligence",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Gemini": {
    "208": {
      "hero_id": "208",
      "disp_name": "Gemini",
      "description": "While fire and ice are typically conflicting elements which negate each other, they are harnessed as one in Gemini. A powerful elemental creature bathed in frost and ember, Gemini confuses foes as contradiction incarnate. Few know - and yet fewer understand - Gemini&#039;s origins, but it has been rumored that he is actually a fusion of two separate entities.",
      "primaryattribute": "Agility",
      "attacktype": "melee",
      "team": "Hellbourne"
    }
  ...
  "Hero_Kenisis": {
    "215": {
      "hero_id": "215",
      "disp_name": "Kinesis",
      "description": "The Prophet teaches that energy flows through all things, we must only harness it for ourselves. The mages invoke incantations, the priests call upon gods wicked and just, but for the truly powerful, the power is harnessed from within. These are the Disciples of the Way and among them there is one known for his mastery over all - Kinesis. Let the Hellbourne beware the power of his mind.",
      "primaryattribute": "Intelligence",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Taint": {
    "212": {
      ...
      "description": "On the battlefields of Newerth, rich in the tainted blood of man, beast, and demon, an ancient evil grows. Consuming the flesh from the fallen he claws his way to the surface, his once dead eyes alive again with hunger and eager to consume the dead. Especially those created by his own undead hands...",
      "primaryattribute": "Intelligence",
      "attacktype": "ranged",
      "team": "Hellbourne"
    }
  ...
  "Hero_FlameDragon": {
    "214": {
      "hero_id": "214",
      "disp_name": "Draconis",
      "description": "The ancient guardian arose, stirred from his centuries of slumber by the cries of help from its creator - the Worldtree. He slowly shook the treasure loose from his scales and took flight - The Demons would soon find that even they could burn in the flames of Draconis, the Great Wyrm.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Blitz": {
    "217": {
      "hero_id": "217",
      "disp_name": "Blitz",
      "description": "Among the Beast Tribes of Newerth a Great Race is held in the savannahs each year. The winner joins their Queen in the battle against the Hellbourne. Many types of warriors compete, some rely on strength, some stealth, and others use speed and cunning. The Grand Champion is the vulpinoid master of velocity - Blitz! Now the Hellbourne daemons must hide to survive, for they certainly cannot run!",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Salomon": {
    "232": {
      "hero_id": "232",
      "disp_name": "Salomon",
      "description": "The mighty Salomon has been summoned by Ophelia to serve as magical guardian of the Legion, and to grant the Hellbourne&#039;s Last Wish.",
      "primaryattribute": "Strength",
      "attacktype": "melee",
      "team": "Legion"
    }
  ...
  "Hero_Prisoner": {
    "233": {
      ...
      "description": "Prisoner 945 led the ground forces of the Titan Rebellion and was imprisoned by Jeraziah in the dungeons of The Capital. He is released in this desperate hour to battle the Hellbourne, but only his actions on the battlefield will finally free him from his chains.",
      "primaryattribute": "Strength",
      "attacktype": "melee",
      "team": "Legion"
    }
  ...
  "Hero_SirBenzington": {
    "234": {
      ...
      "description": "The beavrels are a proud species, fiercely protective of their territory. Dangerous enough with tooth and tail, they have adapted to the daemon threat by forming the Lancer Brotherhood, led by the fearless Sir Benzington upon his loyal fearet Balric. His righteous lance was crafted for one purpose: piercing the very heart of the Hellbourne.",
      "primaryattribute": "Agility",
      "attacktype": "melee",
      "team": "Legion"
    }
  ...
  "Hero_Moira": {
    "238": {
      "hero_id": "238",
      "disp_name": "Moira",
      "description": "One of Harkon&#039;s many apprentices, Moira came into contact with extremely unstable arcane energies when Harkon forged his Blade. Over time she got some control of the energy now within her, leaving her with great power... that she still has trouble controlling.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Legion"
    }
  ...
  "Hero_Tarot": {
    "239": {
      "hero_id": "239",
      "disp_name": "Tarot",
      "description": "Known across the land as a legendary Marksman, she has been in hiding for years. Finally joining the war effort, she has perfected bouncing her shots off anything to always make sure she hits her target.",
      "primaryattribute": "Agility",
      "attacktype": "ranged",
      "team": "Legion"
    }
